...
export class Fuzzr {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Fuzzr.prototype);
        obj.ptr = ptr;
    ...
    */
    constructor(items, options) {
        var ret = wasm.fuzzr_new(addHeapObject(items), isLikeNone(options) ? 0 : addHeapObject(options));
        return Fuzzr.__wrap(ret);
    }
    /**
    * @param {string} query
    * @returns {Array<any>}
    */
    search(query) {
        ...
        var ret = wasm.fuzzr_search(this.ptr, ptr0, len0);
...
async function init(input) {
    ...
    imports.wbg.__wbg_isArray_9daeb1a30751fdc8 = function(arg0) {
    ...
    imports.wbg.__wbg_shift_d7aab142367ca153 = function(arg0) {
        var ret = getObject(arg0).shift();
        return addHeapObject(ret);
    };
